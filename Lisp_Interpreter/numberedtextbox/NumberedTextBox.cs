...
namespace Lisp_Interpreter.numberedtextbox
{
    public partial class NumberedTextBox : UserControl
    {
        ...
        public Color OutsideBackColor
        {
            get
            {
                return outsideBackColor;
            }
            set
            {
        ...
        new public Color BackColor
        {
            get 
            {
                return editBox.BackColor;
            }
            set 
            {
                editBox.BackColor = value;
                Invalidate();
            }
        }
        ...
        {
            g.Clear(OutsideBackColor);
            int y = -editBox.ScrollPos.Y+2;
